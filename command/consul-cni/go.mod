...
require (
	...
	github.com/curtbushko/cni-poc/command v0.0.0-20220609144325-30c699032030
)
...
require (
	...
	github.com/hashicorp/consul-k8s/control-plane v0.0.0-20220603175436-7142fa9c455a // indirect
	github.com/hashicorp/consul/api v1.10.1-0.20220425143126-6d0162a58a94 // indirect
