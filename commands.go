...
import (
	...
	cmdCNIInstall "github.com/hashicorp/consul-k8s/control-plane/subcommand/cni-install"
...
func init() {
	...
	Commands = map[string]cli.CommandFactory{
		...
		"cni-install": func() (cli.Command, error) {
			return &cmdCNIInstall.Command{UI: ui}, nil
		},
	}
}
